export default {
    integration: {
        ...
        modelUnavailable: "模型 {{model}} 当前不可用，请重新选择",
        noModels: "暂无可用的画布图片模型",
        invalidSettings: "请重新设置：{{fields}}",
        settingsAdjusted: "已按所选模型调整：{{fields}}",
        resetSettings: "使用模型默认设置",
    ...
    settingsPanels: {
        ...
        image: { title: "图像设置", quality: "质量", qualities: { low: "标准", medium: "更高", high: "高", auto: "自动" }, size: "尺寸", align16: "16 倍数对齐", align16Hint: "输入完成后自动向上补成 16 的倍数", resolution: "分辨率", aspectRatio: "宽高比", transparent: "透明背景", transparentHint: "开启后生成无背景的透明图像（仅部分模型可用）", count: "生成张数", countGroup: "生成组数", images: "{{count}} 张", groups: "{{count}} 组（4张）" },
    ...
    canvas: {
        ...
        syncedCloudLatest: "已同步云端最新修改",
        conflictWarning: "云端已有新版本，保存时将提示冲突",
        projectDeletedCloud: "该工程已在云端被删除",
        deletedTitle: "工程已被删除",
        deletedDescription: "该工程已在云端被删除。您可以将本地未保存的内容另存为新工程，或放弃修改并退出。",
        discardAndExit: "放弃并退出",
        conflictTitle: "工程版本冲突",
        conflictDescription: "云端工程已被其他端更新，存在版本冲突。请选择保留本地内容并另存为新工程，或者放弃本地修改并重新加载云端最新版本。",
        saveAsCopy: "另存为新工程",
        saveAsCopyFailed: "另存为新工程失败",
        copySuffix: " (副本)",
        discardLocal: "放弃本地修改",
        unsavedLeaveWarning: "当前画布有未保存的修改，离开将丢失这些内容。确定要离开吗？",
        leaveTasksRunningWarning: "当前有任务正在生成中，离开可能会导致中断。确定要离开吗？",
        leaveConfirmOk: "确认离开",
        stayOnPage: "留在此页",
        shortcuts: "快捷键",
        miniMapOpen: "打开小地图",
        ...
        sidePanel: {
            ...
            addingAssets: "正在添加资产…", addedAssets: "已添加 {{count}} 个资产", mediaOnly: "仅支持图片或视频文件", addFailed: "添加失败，请重试", searchAssets: "搜索资产", add: "添加", noAssets: "暂无资产", inserted: "插入画布", removeAssetTitle: "移除该资产？", remove: "移除", removeAsset: "移除资产", assetRemoved: "资产已移除", imageNotReady: "图片尚未同步完成",
        ...
        imageTools: { copyPrompt: "复制提示词", copyPromptTitle: "复制生成该图片的提示词", reversePrompt: "反推提示词", reversePromptTitle: "创建反推提示词的文本和配置节点", replace: "替换图片", locked: "锁比例", free: "自由比例", lockTitle: "切换为等比缩放", freeTitle: "切换为自由比例", mask: "局部编辑", maskTitle: "添加蒙版遮罩后局部修改", maskEditUnsupported: "当前模型暂不支持局部编辑", crop: "裁剪", cropTitle: "裁剪并生成新节点", split: "切图", splitTitle: "按行列切分图片", upscale: "放大", upscaleTitle: "放大图片分辨率", superResolve: "超分", superResolveTitle: "AI 超分", angle: "多角度", angleTitle: "生成角度", view: "查看大图", viewTitle: "查看图片详情", more: "更多", configure: "配置快捷工具", customize: "自定义工具栏", showLabels: "显示按钮文字", description: "选择你想在图片节点编辑栏中使用的快捷工具。", preview: "节点预览", imageNode: "图片节点", quickTools: "快捷工具" },
        ...
        controls: { ratio: "比例", duplicate: "复制", delete: "删除", images: "{{count}} 张", groups: "{{count}} 组", texts: "{{count}} 条", generations: "{{count}} 次", reasoning: "推理" },
