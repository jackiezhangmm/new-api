export default {
    integration: {
        ...
        modelUnavailable: "Model {{model}} is unavailable. Select a model again.",
        noModels: "No canvas image models available",
        invalidSettings: "Update these settings: {{fields}}",
        settingsAdjusted: "Adjusted for the selected model: {{fields}}",
        resetSettings: "Use model defaults",
    ...
    settingsPanels: {
        ...
        image: { title: "Image settings", quality: "Quality", qualities: { low: "Standard", medium: "Higher", high: "High", auto: "Auto" }, size: "Size", align16: "Align to multiples of 16", align16Hint: "Round dimensions up to the next multiple of 16 after input", resolution: "Resolution", aspectRatio: "Aspect ratio", transparent: "Transparent background", transparentHint: "Generate an image without a background when supported by the model", count: "Image count", countGroup: "Group count", images: "{{count}} images", groups: "{{count}} set (4 images)" },
    ...
    canvas: {
        ...
        syncedCloudLatest: "Synced latest changes from cloud",
        conflictWarning: "Cloud has a newer version, saving will prompt conflict",
        projectDeletedCloud: "This project has been deleted from the cloud",
        deletedTitle: "Project Deleted",
        deletedDescription: "This project has been deleted from the cloud. You can save your unsaved changes as a new project, or discard changes and exit.",
        discardAndExit: "Discard and Exit",
        conflictTitle: "Project Version Conflict",
        conflictDescription: "This project has been updated on another device or tab. You can save your local changes as a new project or discard local changes and load the latest version.",
        saveAsCopy: "Save as Copy",
        saveAsCopyFailed: "Failed to save as new project",
        copySuffix: " (Copy)",
        discardLocal: "Discard Local Changes",
        unsavedLeaveWarning: "You have unsaved changes. Leaving now will discard them. Are you sure you want to leave?",
        leaveTasksRunningWarning: "Tasks are currently running. Leaving now may interrupt them. Are you sure you want to leave?",
        ...
        controls: { ratio: "Ratio", duplicate: "Duplicate", delete: "Delete", images: "{{count}} images", groups: "{{count}} groups", texts: "{{count}} options", generations: "{{count}} runs", reasoning: "Reasoning" },
