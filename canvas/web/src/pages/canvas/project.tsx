...
function InfiniteCanvasPage() {
    ...
    const renderNodePanel = useCallback(
        (panelNode: CanvasNodeData) =>
            getNodeDefinition(panelNode.type)?.Panel ? (
                ...
                <CanvasNodePromptPanel
                    node={panelNode}
                    nodes={nodes}
                    isRunning={runningIds.has(panelNode.id)}
        ...
        [configInputsById, confirmStopGeneration, connectedNodesByNodeId, disconnectNodeReference, handleConfigNodeChange, handleGenerateNode, handleNodePromptChange, mentionReferencesByNodeId, nodes, renderPluginPanel, runningIds, startNodeReferenceSelection],
    );
    ...
    const renderNodeContentPanel = useCallback(
        (contentNode: CanvasNodeData) => (
            <CanvasConfigNodePanel
                node={contentNode}
                isRunning={runningIds.has(contentNode.id)}
        ...
        [configInputsById, confirmStopGeneration, handleConfigNodeChange, handleGenerateNode, runningIds],
    );
